...
func TestFolderErrors(t *testing.T) {
	...
	if m.FolderError("folder") != "Folder marker missing" {
		t.Error("Incorrect error: Folder marker missing !=", m.FolderError("folder"))
	}
	...
	if m.FolderError("folder") != "Folder path missing" {
		t.Error("Incorrect error: Folder path missing !=", m.FolderError("folder"))
	}
